...
namespace GameyMickGameFace.Menus
{
    public class Score
    {
        ...
        public void Draw(GameTime time, SpriteBatch batch)
        {
            ...
            batch.DrawString(Media.Fonts.GUI, "Player 3: " + currentLevel.Player3.Score, new Vector2(100, 200), Color.Black);
            batch.DrawString(Media.Fonts.GUI, "Player 4: " + currentLevel.Player4.Score, new Vector2(100, 250), Color.Black);
        }
    }
}
