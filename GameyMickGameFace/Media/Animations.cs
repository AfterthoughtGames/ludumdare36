...
namespace GameyMickGameFace.Media
{
    public class Animations
    {
        public static void Load(ContentManager cm)
        {
            ...
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_000"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_001"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_002"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_003"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_004"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_005"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_006"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_007"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_008"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_009"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_010"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_011"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_012"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_013"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_014"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_015"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_016"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_017"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_018"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_019"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_020"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_021"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_022"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_023"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_024"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_025"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_026"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_027"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_028"));
            WalkingWithSword.AddTexture(cm.Load<Texture2D>("Characters/OtterFrames/Otter_Otter_Walking_Swords_029"));
